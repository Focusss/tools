...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:ctx+"/UploadFileServlet?method=fileuploadueditor"             //图片上传提交地址
        ,imagePath:""                     						//图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageFieldName:"fileNames"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion', 'pagebreak', '|',
        ...
        ,toolbars:[
                   ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                       'bold', 'italic', 'underline', 'strikethrough','|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','|', '|','fontfamily', 'fontsize', '|', 'insertimage', 'emotion', 'pagebreak', '|', 'spechars','|',
                       'inserttable', '|','preview']
               ]*/
        ...
        ,labelMap:{
            ...
            'selectall':'全选', 'print':'打印', 'preview':'预览',
